...
} B_TotalVoltageOverVoltage_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  uint8_T is_active_c3_TotalVoltageOverVo;/* '<Root>/Chart' */
...
/* Block signals (auto storage) */
extern B_TotalVoltageOverVoltage_T TotalVoltageOverVoltage_B;
 ...
 * '<S1>'   : 'TotalVoltageOverVoltage/Chart'
 */
